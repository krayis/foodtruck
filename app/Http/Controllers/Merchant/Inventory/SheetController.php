...
class SheetController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('merchant.inventory.sheets.index', compact('sheets'));
    }
    ...
    public function create()
    {
        ...
        return view('merchant.inventory.sheets.create', compact('items','timezone', 'events', 'templates', 'template'));
    }
    ...
    public function edit(InventorySheets $sheet)
    {
        ...
        return view('merchant.inventory.sheets.edit', compact('sheet', 'items', 'sheetItems', 'event'));
    }
