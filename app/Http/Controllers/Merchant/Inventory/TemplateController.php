...
class TemplateController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('merchant.inventory.templates.index', compact('inventories'));
    }
    ...
    public function edit(InventoryTemplates $template)
    {
        ...
        return view('merchant.inventory.templates.edit', compact('template', 'items', 'inventoryItems', 'event'));
    }
