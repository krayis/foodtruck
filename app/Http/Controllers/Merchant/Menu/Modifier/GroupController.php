...
namespace App\Http\Controllers\Merchant\Menu\Modifier;
...
class GroupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('merchant.menu.modifier.group.index', compact('categories'));
    }

    public function create()
    {
        return view('merchant.menu.modifier.group.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('merchant.menu.modifier.group.index')->with('success', 'Modifier group was successfully added.');
    }

    public function show(ModifierGroup $group)
    {
        return view('merchant.menu.modifier.group.show', compact('group'));
    }
    public function edit(ModifierGroup $group)
    {
        return view('merchant.menu.modifier.group.edit', compact('group'));
    }
    ...
    public function update(Request $request, ModifierGroup $group)
    {
        ...
        return redirect()->route('merchant.menu.modifier.group.edit', $group->id)->with('success', 'Modifier group was successfully updated.');
    }
    ...
    public function destroy(ModifierGroup $group)
    {
        ...
        return redirect()->route('merchant.menu.modifier.group.index')->with('success', 'Modifier category was successfully deleted.');
    }
