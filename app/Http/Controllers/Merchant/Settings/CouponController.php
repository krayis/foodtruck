...
class CouponController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('merchant.settings.coupon.index', compact('coupons'));
    }

    public function create()
    {
        return view('merchant.settings.coupon.create');
    }

    public function edit(Coupon $coupon)
    {
        return view('merchant.settings.coupon.edit', compact('coupon'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('merchant.settings.coupons.index')->with('success', 'Coupon was successfully added.');
    }
    ...
    public function update(Request $request, Coupon $coupon)
    {
        ...
        return redirect()->route('merchant.settings.coupons.index')->with('success', 'Coupon was successfully updated.');
    }

    public function destroy(Request $request, Coupon $coupon)
    {
        $coupon->delete();
        return redirect()->route('merchant.settings.coupons.index')->with('success', 'Coupon was successfully deleted.');
    }
}
