...
class PaymentController extends Controller
{
    ...
    {
        $user = Auth::user();
        return view('truck.settings.payment.index', compact('user'));
    }
    ...
    public function update(Request $request, UserPaymentProvider $payment) {
        ...
        return redirect()->route('truck.settings.payments.index')->with('success', 'Payment was updated successfully');
    }
