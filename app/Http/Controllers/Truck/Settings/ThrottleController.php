...
class ThrottleController extends Controller
{
    ...
    {
        $user = Auth::user();
        return view('truck.settings.throttle.index', compact('user'));
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('truck.settings.throttle.index')->with('success', 'Throttling successfully updated');
    }
}
