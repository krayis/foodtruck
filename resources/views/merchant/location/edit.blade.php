...
@section('content')
    ...
    <form action="{{ route('merchant.location.destroy', $location->id) }}" style="display: none;" id="delete-form"
          method="POST">
        @csrf
        @method('DELETE')
    </form>

    <form action="{{ route('merchant.location.update', $location->id) }}" method="POST">
        @csrf
        @method('PATCH')

        <div class="meta-header">
            <div class="meta-inner">
                <a href="{{ route('merchant.location.index') }}" class="back">
