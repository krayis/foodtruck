...
@section('content')
    ...
    <form id="item-form" action="{{ route('merchant.menu.item.update', $item->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
                                    ...
                                    <div class="more">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                                <li>
                                                    <a href="{{ route('merchant.menu.item.edit', $categories->id ) }}">
                                                        Remove
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('merchant.menu.modifier.group.edit', $categories->id ) }}">
                                                        Edit Modifier Group
                                                    </a>
                                                </li>
                                            </ul>
    ...
    <form action="{{ route('merchant.menu.item.update',  $item->id) }}" id="form-delete-thumbnail"
          style="display: none;"
          method="POST">
        @csrf
        @method('PATCH')
    ...
    <form action="{{ route('merchant.menu.item.destroy',  $item->id) }}" id="form-delete"
          style="display: none;"
          method="POST">
        @csrf
        @method('DELETE')
