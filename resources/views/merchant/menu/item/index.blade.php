...
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="page-action">
            <a class="btn btn-primary" href="{{ route('merchant.menu.item.create') }}"><ion-icon name="add"></ion-icon> New Item</a>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            @foreach($item->modifierGroups as $category)
                                <div>
                                    <a href="{{ route('merchant.menu.modifier.group.show', $category->id/**/) }}">{{ $category->name }}</a>
                                </div>
                            @endforeach
                        </td>
