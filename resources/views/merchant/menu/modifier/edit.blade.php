...
<form action="{{ route('merchant.menu.modifier.update', $modifier->id) }}" method="POST"
    ...
    <div class="meta-header">
        <div class="meta-inner">
            <a href="{{ route('merchant.menu.modifier.index') }}" class="back">
...
<form action="{{ route('merchant.menu.modifier.destroy', $modifier->id) }}" style="display: none;" id="delete-form"
      method="POST">
    @csrf
    @method('DELETE')
</form>
