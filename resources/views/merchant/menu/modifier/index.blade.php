...
@include('merchant.menu._partials.navtabs')
    ...
    <div class="page-header">
        ...
        <div class="page-action">
            <a class="btn btn-primary" href="{{ route('merchant.menu.modifier.create') }}"><ion-icon name="add"></ion-icon> New Modifier</a>
        </div>
    </div>
        ...
        <table class="table table--modifier">
            ...
            @foreach($modifiers as $modifier)
                <tr>
                    <td><a href="{{ route('merchant.menu.modifier.edit', $modifier->id) }}">{{$modifier->name}}</a></td>
