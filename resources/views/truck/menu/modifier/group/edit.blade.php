...
@section('content')
    ...
    <form action="{{ route('truck.menu.modifier.group.update', $group->id) }}" method="POST"
    ...
    <form action="{{ route('truck.menu.modifier.group.destroy', $group->id) }}" style="display: none;" id="delete-form"
          method="POST">
        @csrf
        @method('DELETE')
    </form>
