...
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="page-action">
            <a class="btn btn-primary" href="{{ route('truck.menu.modifier.group.create') }}"><ion-icon name="add"></ion-icon> New Group</a>
        </div>
    </div>
    ...
    <table class="table table--modifier">
        ...
        @foreach($categories as $category)
            <tr>
                <td>
                    <a href="{{ route('truck.menu.modifier.group.edit', $category->id) }}">
                        {{ $category->name }}
                    </a>
                </td>
                ...
                <td>
                    ...
                    <form action="{{ route('truck.menu.modifier.group.destroy', $category->id) }}"
